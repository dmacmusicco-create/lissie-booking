...
export default function CalendarGrid({ availability, loading, onDayClick }: CalendarGridProps) {
  ...
  return (
    <div className="space-y-10">
      {months.map(({ label, days }) => {
        // Find the day-of-week offset for the first day
            ...
            <div className="grid" style={{ gridTemplateColumns: 'repeat(7, 1fr)', gap: '6px' }}>
              ...
              {days.map((day, idx) => (
                <DayCard
                  ...
                  onClick={() => onDayClick(day.date, day.available)}
